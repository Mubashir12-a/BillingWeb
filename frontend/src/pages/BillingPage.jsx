...
export default function BillingPage() {
  ...
  async function handleSend(customer) {
    ...
    // Let React render the bill preview before html2canvas captures it
    ...
    try {
      ...
      try {
        ...
        const imgRes = await fetch(
          `https://api.imgbb.com/1/upload?key=${STORE.imgbbKey}`,
          {
            method: 'POST',
            body: fd
          }
      ...
      window.open(
        `https://wa.me/${customer.phone}?text=${encodeURIComponent(msg)}`,
        '_blank'
      )
    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            Main Market, Soura Srinagar | PIN: 190011
          </p>
        </div>
      ...
      <header className="page-header">
        ...
        <div className="header-actions">
          ...
          <input
            ...
            aria-label="Select billing date"
            style={{
              position: 'absolute',
              width: '1px',
              height: '1px',
